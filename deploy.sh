...
printf "\n"
echo "[3] Changing branch to main and getting latest commits."
printf "\n"
cd projeto-ssc0541-grupo-06 && git fetch --all && git checkout main && git reset --hard checkpoint1-submission
printf "\n"
