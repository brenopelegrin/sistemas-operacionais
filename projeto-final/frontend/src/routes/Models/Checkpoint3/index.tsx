...
import { make_checkpoint3_post, makeGet } from '../../../components/TaskFetch';
...
export default function Checkpoint3Page() {
    ...
    onSuccess: async (data, variables) => {
        ...
        if(status != 'SUCCESS'){
            ...
            if (!isEmpty(data["data"]["result"])){
                ...
                navigate('/models/checkpoint3/results');
            } else {
                await sleep(500);
                mutateGet({id}); 
            }
  ...
  const {mutate: mutatePost, data: dataPost, error: errorPost, isError: isErrorPost, isSuccess: isSuccessPost} = useMutation(make_checkpoint3_post,
    {
